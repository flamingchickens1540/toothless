...
public class Auto5BallSequence extends SequentialCommandGroup {
    public Auto5BallSequence(Drivetrain drivetrain, Intake intake, Indexer indexer, Shooter shooter, Hood hood, Limelight limelight, LIDAR lidar) {
        addCommands(
                ...
                new ShootSequence(shooter, indexer, drivetrain, hood, intake, limelight, lidar, Shooter.ShooterProfile.FAR, false).withTimeout(5),        // Shoot the 2 indexed balls (starts with one, collects one)
                ...
                new ConditionalCommand(                                                          // If (2 balls are indexed) then shoot, else keep going
                        new ShootSequence(shooter, indexer, drivetrain, hood, intake, limelight, lidar, Shooter.ShooterProfile.FAR, false).withTimeout(5),
