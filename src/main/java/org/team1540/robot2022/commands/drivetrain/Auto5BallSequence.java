...
public class Auto5BallSequence extends SequentialCommandGroup {
    public Auto5BallSequence(Drivetrain drivetrain, Intake intake, Indexer indexer, Shooter shooter, Hood hood, Limelight limelight) {
        addCommands(
                ...
                new ConditionalCommand(                                                          // If (2 balls are indexed) then shoot, else keep going
                    new ShootSequence(shooter, indexer, drivetrain, hood, intake, limelight), 
                ...
                new ShootSequence(shooter, indexer, drivetrain, hood, intake, limelight)         // Shoot the fifth ball
        );
    }
}
